...
console.log("activityOptionRun" + activities +activityIconX + "acitivyY"+ activityIconY);
...
activitiesState = "visible";
   ...
   // 
    ...
    displayActivityOptions(activities, activitiesDiv, activitiesState);
       ...
       if(checkActivity("pizza")){
         activities = "pizzaIcon";
   // 
      activitiesDiv = "pizza";

    displayActivityOptions(activities, activitiesDiv, activitiesState);
    console.log("displya PIzza");
  }
         if(checkActivity("dinner")){
...
console.log("timeH   " + timeH)
  ...
  if (checkOverlap(timeH, timeM)){
    ...
    setCookie(name[0], joinedValues);
     var allCookies = getAllCookies(); //store all cookies in variable
  console.log("all cookies true:"+allCookies);
...
iconAngle=iconAngle*(Math.PI/180);
 ...
 console.log("dXSS" + (delatas[i][0] = (0 + (Math.cos(iconAngle)) * (235))));
  console.log(activitySetIconX);
  deltas[i][1] = (0 + (Math.sin(iconAngle)) * (235));
  }
}
...
function checkOverlap(hours, minutes) {
  ...
  var noOverlap = true;
  var tempArray;
  var allCookies = getAllCookies(); //store all cookies in variable problem!!
  console.log("all cookies:"+allCookies);

  for (var i = 0; i < allCookies.length; i++) {
    console.log("allthecookies" + allCookies);
    var t1 = parseInt(hours)*60 + parseInt(minutes);
    var t2 = parseInt(allCookies[i][1])*60 + parseInt(allCookies[i][2]);
    console.log("t1:" +t1);
    console.log("t2:" +t2);
    if ((t2 < t1) && (t2 + 30 < t1)) {
      noOverlap = true;
...
/*
      ...
      var t4 = t2.toString() + allCookies[i][2] + "00";
      console.log(t2);
      console.log(t4);
